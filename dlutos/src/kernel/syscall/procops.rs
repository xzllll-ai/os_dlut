...
use dlutos_hal::processor::UserTLS;
use dlutos_hal::traits::trap::RawTrapContext;
use dlutos_hal::trap::TrapContext;
use dlutos_mm::address::Addr as _;
use dlutos_sync::AsProof as _;
...
#[dlutos_macros::define_syscall(SYS_NANOSLEEP)]
...
#[dlutos_macros::define_syscall(SYS_CLOCK_NANOSLEEP)]
...
#[dlutos_macros::define_syscall(SYS_UMASK)]
...
#[dlutos_macros::define_syscall(SYS_GETCWD)]
...
#[dlutos_macros::define_syscall(SYS_FCHDIR)]
...
#[dlutos_macros::define_syscall(SYS_CHDIR)]
...
#[dlutos_macros::define_syscall(SYS_UMOUNT)]
...
#[dlutos_macros::define_syscall(SYS_MOUNT)]
...
#[dlutos_macros::define_syscall(SYS_EXECVE)]
...
#[dlutos_macros::define_syscall(SYS_EXIT)]
...
#[dlutos_macros::define_syscall(SYS_EXIT_GROUP)]
...
#[dlutos_macros::define_syscall(SYS_WAITID)]
async fn waitid(
    id_type: u32,
    id: u32,
...
#[dlutos_macros::define_syscall(SYS_WAIT4)]
async fn wait4(
    wait_id: i32,
    arg1: UserMut<u32>,
    options: u32,
...
#[dlutos_macros::define_syscall(SYS_SETSID)]
async fn setsid() -> KResult<u32> {
    thread.process.setsid().await
}

#[dlutos_macros::define_syscall(SYS_SETPGID)]
...
#[dlutos_macros::define_syscall(SYS_GETSID)]
...
#[dlutos_macros::define_syscall(SYS_GETPGID)]
...
#[dlutos_macros::define_syscall(SYS_GETPID)]
async fn getpid() -> KResult<u32> {
    Ok(thread.process.pid)
}

#[dlutos_macros::define_syscall(SYS_GETPPID)]
...
#[dlutos_macros::define_syscall(SYS_GETUID)]
async fn getuid() -> KResult<u32> {
    do_getuid(thread)
}

#[dlutos_macros::define_syscall(SYS_GETEUID)]
async fn geteuid() -> KResult<u32> {
    do_geteuid(thread)
}

#[dlutos_macros::define_syscall(SYS_GETEGID)]
async fn getegid() -> KResult<u32> {
    // All users are root for now.
    Ok(0)
}

#[dlutos_macros::define_syscall(SYS_GETGID)]
async fn getgid() -> KResult<u32> {
    sys_getegid(thread).await
}

#[dlutos_macros::define_syscall(SYS_SCHED_YIELD)]
async fn sched_yield() -> KResult<()> {
    yield_now().await;
    Ok(())
}

#[dlutos_macros::define_syscall(SYS_SYNC)]
async fn sync() -> KResult<()> {
    Ok(())
}

#[dlutos_macros::define_syscall(SYS_FSYNC)]
async fn fsync() -> KResult<()> {
    Ok(())
}

#[dlutos_macros::define_syscall(SYS_GETTID)]
...
#[dlutos_macros::define_syscall(SYS_KILL)]
...
#[dlutos_macros::define_syscall(SYS_TKILL)]
...
#[dlutos_macros::define_syscall(SYS_TGKILL)]
...
#[dlutos_macros::define_syscall(SYS_RT_SIGPROCMASK)]
...
#[dlutos_macros::define_syscall(SYS_RT_SIGSUSPEND)]
...
#[dlutos_macros::define_syscall(SYS_RT_SIGTIMEDWAIT_TIME32)]
...
#[dlutos_macros::define_syscall(SYS_RT_SIGACTION)]
...
#[dlutos_macros::define_syscall(SYS_PRLIMIT64)]
async fn prlimit64(
    pid: u32,
    resource: u32,
...
#[dlutos_macros::define_syscall(SYS_GETRUSAGE)]
...
// RISC-V keeps the last two clone arguments in this order.
#[dlutos_macros::define_syscall(SYS_CLONE)]
async fn clone(
    clone_flags: usize,
    new_sp: usize,
...
#[dlutos_macros::define_syscall(SYS_FUTEX)]
async fn futex(
    uaddr: usize,
    op: u32,
    val: u32,
...
#[dlutos_macros::define_syscall(SYS_SET_ROBUST_LIST)]
...
#[dlutos_macros::define_syscall(SYS_RT_SIGRETURN)]
...
#[dlutos_macros::define_syscall(SYS_SCHED_GETAFFINITY)]
