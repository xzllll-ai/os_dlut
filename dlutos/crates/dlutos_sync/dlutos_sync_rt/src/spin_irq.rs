use dlutos_hal::traits::trap::IrqState as _;
use dlutos_hal::trap::{disable_irqs_save, IrqState};
use dlutos_spin::{ContextUnlock, Spin, SpinContext, SpinGuard, UnlockedContext};
use dlutos_sync_base::Relax;
