...
/// # Usage
/// ```no_run
/// #[dlutos_hal::default_trap_handler]
...
///
/// ```ignore
/// [unsafe] fn ident(ident: dlutos_hal::bootstrap::BootStrapData) -> !
/// ```
///
/// # Usage
/// ```no_run
/// #[dlutos_hal::main]
/// fn kernel_main(data: dlutos_hal::bootstrap::BootStrapData) -> ! {
///     // ...
/// }
/// ```
#[proc_macro_attribute]
pub fn main(attrs: TokenStream, item: TokenStream) -> TokenStream {
    ...
    quote! {
        #(#attrs)*
        #[export_name = "_dlutos_hal_main"]
        pub #unsafety fn #ident(
            #arg_ident: dlutos_hal::bootstrap::BootStrapData,
        ) -> ! #block
    }
    .into()
}
...
///
/// ```ignore
/// [unsafe] fn ident(ident: dlutos_mm::address::PRange) -> !
/// ```
///
/// # Usage
/// ```no_run
/// #[dlutos_hal::main]
/// fn ap_main(stack_range: dlutos_mm::address::PRange) -> ! {
///     // ...
/// }
/// ```
#[proc_macro_attribute]
pub fn ap_main(attrs: TokenStream, item: TokenStream) -> TokenStream {
    ...
    quote! {
        #(#attrs)*
        #[export_name = "_dlutos_hal_ap_main"]
        pub #unsafety fn #ident(
            #arg_ident: dlutos_mm::address::PRange,
        ) -> ! #block
    }
    .into()
}
