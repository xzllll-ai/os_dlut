...
#[dlutos_macros::define_syscall(SYS_MMAP)]
async fn mmap(
    addr: usize,
    len: usize,
    prot: UserMmapProtocol,
...
#[dlutos_macros::define_syscall(SYS_MUNMAP)]
...
#[dlutos_macros::define_syscall(SYS_BRK)]
...
#[dlutos_macros::define_syscall(SYS_MADVISE)]
async fn madvise(_addr: usize, _len: usize, _advice: u32) -> KResult<()> {
    Ok(())
}

#[dlutos_macros::define_syscall(SYS_MREMAP)]
async fn mremap(
    old_addr: usize,
    old_size: usize,
    new_size: usize,
...
#[dlutos_macros::define_syscall(SYS_MPROTECT)]
...
#[dlutos_macros::define_syscall(SYS_SHMGET)]
...
#[dlutos_macros::define_syscall(SYS_SHMAT)]
...
#[dlutos_macros::define_syscall(SYS_SHMDT)]
...
#[dlutos_macros::define_syscall(SYS_SHMCTL)]
async fn shmctl(_shmid: u32, _op: i32, _shmid_ds: usize) -> KResult<usize> {
    // TODO
    Ok(0)
}

#[dlutos_macros::define_syscall(SYS_MEMBARRIER)]
